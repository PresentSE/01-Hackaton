...
export class ShapeModule extends Module {
    ...
    trigger() {
        ...
        switch (typeOfShape) {
            ...
            case 2:
                //ellipse
                shape.style.clipPath = `ellipse(${random(10, 50)}% ${random(10, 50)}% at 50% 50%)`;
                break;
            case 3:
                //blob
                shape.style.borderRadius = `${random(20, 100)}% ${random(20, 100)}% ${random(20, 100)}% ${random(20, 100)}% / ${random(20, 100)}% ${random(20, 100)}% ${random(20, 100)}% ${random(20, 100)}%`;
                break;
        }

        //appearance
        shape.style.background = `linear-gradient(${random(0, 359)}deg, ${getRandomColor()}, ${getRandomColor()})`;
